...
| 2026-09-20 | **新增 SM-U1-3 四份觀念講義與投影片**：完成「土壤三相關係的萬用鑰匙」、「壓密沉陷四部曲」、「壓密速率與超載預壓」、「夯實曲線與夯實能量」四個主題的 PDF、PPTX 與 SVG 圖檔及腳本 | 使用者新增 |
| 2026-09-25 | **新增 SM-U2-3 及 SM-U3-1 觀念講義與筆記**：包含開挖擋土與側向土壓力的 PDF 及分類資料夾 | 使用者新增 |

...
**副分類：** 無
**分析法：** 有效應力法
**標籤：** `Darcy定律` `滲透係數` `等效滲透係數` `水頭損失` `總水頭` `層狀土壤滲流`
---
...
![SM-2022-3 題目附圖：垂直層狀滲流試驗裝置立體圖，方形斷面柱體由上而下依序為自由水（上水位面）、土壤 A、土壤 B、土壤 C，柱底以 U 型管接至右側低水位溢流槽（下水位面），a/b/c/d 四點分別標於水土交界面、A-B 交界、B-C 交界與 C 層底部](SM-2022-3-fig-1.png)
...
*圖上以一支貫穿全高的尺寸線標註 $h = 600$ mm，為上、下水位面之間的**總水頭差**。圖下另有兩行原圖註記：「$H_A$、$H_B$ 及 $H_C$ 分別為土體長度」「$h$ 為上下水位面水頭差」。*

*因此：水流由上往下（a → d），d 點為基準面（總水頭 = 0），三層土為**串聯**（同一流量、水頭損失分配於三層），土體總長 $L = 50+100+50 = 200$ mm。*
